 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://127.0.0.1/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@gamu.ca");
define("EMAIL_PASSWORDRESET_FROM_NAME", "No Reply GAMU");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for GAMU");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://127.0.0.1/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@gamu.ca");
define("EMAIL_VERIFICATION_FROM_NAME", "No Reply GAMU");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for GAMU");
