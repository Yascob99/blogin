...
define("MESSAGE_EMAIL_ALREADY_EXISTS", "This email address is already registered.");
...
define("MESSAGE_USER_REAL_NAME_EMPTY", "Real Name field was empty");
...
define("WORDING_REGISTRATION_EMAIL", "User's email (required)");
define("WORDING_REGISTRATION_PASSWORD", "Password");
define("WORDING_REGISTRATION_PASSWORD_REPEAT", " Repeat Password");
define("WORDING_REGISTRATION_USERNAME", "Username (Required on full account registration)");
define("WORDING_REGISTRATION_REAL_NAME", "Name (Required)");
...
define("WORDING_USERNAME", "Username, Email or Real Name");
